...
function listaInfluencias(list){
    list.forEach(artista => {
        console.log("De: ", artista.name);
        artista.influences.forEach(influencia => {
            console.log("La influencia es: ", influencia);
        })
    });
}

listaInfluencias(artists)
